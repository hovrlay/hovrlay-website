  ...
  return (
    <section id="home" className="py-20 mt-24">
      <div className="container-custom z-10 mx-4 md:mx-8 lg:mx-12">
        ...
        <div className="flex flex-col items-center text-center lg:max-w-2xl lg:mx-auto">
          {/* Text content section */}
          <div className="animate-fade-in-down mb-32">
            <h1 className="text-6xl md:text-6xl lg:text-7xl font-semibold text-foreground mb-10">
              <span className="hero-gradient">AI wingman</span> for every conversation
            </h1>
            <p className="text-base sm:text-base md:text-lg lg:text-xl text-muted-foreground max-w-3xl mb-8 font-light mx-auto">
